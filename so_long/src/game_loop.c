...
/*   Updated: 2025/12/06 12:28:03 by masenjo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/so_long.h"

static int	check_position(t_position next, t_solong *game)
{
...
static void	check_coin_print_last_visited(t_position next, t_solong *game)
{
...
int	try_move_player(t_solong *game, int add_x, int add_y)
{
	...
	if (!check_position(next, game))
		return (0);
	check_coin_print_last_visited(next, game);
