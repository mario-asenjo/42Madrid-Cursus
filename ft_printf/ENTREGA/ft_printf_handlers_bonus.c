...
/*   Updated: 2025/10/24 17:15:44 by masenjo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	handle_width(t_printf_token *token,
			va_list args, char const *str, size_t *i)
{
	if (str[*i] == '*')
	{
...
void	handle_precision(t_printf_token *token,
			va_list args, char const *str, size_t *i)
{
	if (str[*i] == '.')
	{
